...
void menu()
{
  Serial.println("--- Choose an option and press enter ---");
  Serial.print("1 Calibrate colors (you have ");
  Serial.print(colorNumber);
  Serial.println(" colors)");
  Serial.println("2 Read color (once)");
  Serial.println("3 Read color (loop)");
  switch(getChar())
  {
    case '1': // Recalibration
      calibrate();
      break;
    case '2': // Read color (once)
      Serial.println(readColor());
      break;
    case '3': // Read color (loop)
